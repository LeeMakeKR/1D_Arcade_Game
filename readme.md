...
미터당 60개의 LED가 들어있는 제품을 선택하고, 3미터 사용. 
이중 8개를 잘라내어 2개 모듈의 스위치에 각각 4개씩 사용한다. 
LED 라인은 총 180-8 = 172개 사용.
WS2812 사용시 전압 강하 문제로 끝부분 LED가 어두워지거나 색이 안맞는 문제 있음. WS2815 사용할 것. 

i2s MAX98357A 모듈(앰프 포함) - 멀티트랙 재생 가능
2개의 스피커를 병렬로 연결하여 출력한다.
